...
<div class="tc">
    ...
    点<input type="button" value="这里" style="border-width:0px" 
...
<div class="tips">
<h3> 游戏说明</h3>
想要令鲜花怒放,就要让它有充足的水分,帮花根连上水吧,<br/>
在左上角名字已经自动获得,请点start开始游戏,<br/>
鼠标操作改变根的方向,玩法类似接水管! <br/>
</div>
...
<script language="JavaScript" type="text/javascript">
	AC_FL_RunContent(
		...
		'movie', 'help_plants',
		'flashvars', 'username=<?echo($name);?>',
		'salign', ''
		); //end AC code
</script>
<noscript>
	<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0" width="800" height="600" id="help_plants" align="middle">
	<param name="allowScriptAccess" value="sameDomain" />
	<param name="allowFullScreen" value="true" />
	<param name="movie" value="help_plants.swf" />
	<param name="quality" value="high" />
	<param name="bgcolor" value="#ffffff" />
	<param name="flashvars" value="username=<?echo($name);?>" />
    <embed src="help_plants.swf" quality="high" bgcolor="#ffffff" 
        width="800" height="600" name="help_plants" align="middle" 
